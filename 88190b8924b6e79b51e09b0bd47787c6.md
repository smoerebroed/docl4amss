...
This section describes analysis of the ELF file with MD5 sum [88190b8924b6e79b51e09b0bd47787c6](88190b8924b6e79b51e09b0bd47787c6.md).  This file contains the L4 kernel and the servers that it starts up at boot.



# Details #

The ELF file has 19005440 bytes and an MD5 sum of [88190b8924b6e79b51e09b0bd47787c6](88190b8924b6e79b51e09b0bd47787c6.md). It has the following
ELF sections

```
  Offset   VirtAddr   PhysAddr   FileSiz MemSiz  Flg Align
  0x001000 0x17c03000 0x17c03000 0x0017c 0x01000     0x0
  ...
  0x044000 0xb0e00000 0x00a3a000 0x04000 0x04000 RW  0x1000 - [1]
  0x050000 0xb0100000 0x00a26000 0x06f9f 0x06f9f R E 0x8000 - ig_naming server
  0x058000 0xb0140000 0x00a2d000 0x000d8 0x001b8 RW  0x8000 - ig_naming data
  0x060000 0xb0200000 0x00a2e000 0x089b3 0x089b3 R E 0x8000 - qdms server
  0x070000 0xb0240000 0x00a37000 0x000d8 0x0028c RW  0x8000 - qdms data
  0x071000 0xb0300000 0x00a40000 0x08120 0x20a9c RWE 0x4    - quartz server
  0x07a000 0x00b07000 0x00b07000 0x03000 0x03000 R E 0x1000 - amss server
  0x07e000 0x00b0a000 0x00b0a000 0x900000 0x900000 R E 0x1000 - amss data?
  0x97f000 0x0140a000 0x0140a000 0x1fe90 0xa51a60 RWE 0x200 - [2]
  0x99f000 0x16e00000 0x16e00000 0x83b000 0x83b000 R E 0x1000 - [3]
  0x11db000 0x1763b000 0x1763b000 0x2aec4 0x577000 RW  0x1000
  0x1206000 0x17bb2000 0x17bb2000 0x00014 0x500c0 RW  0x8

[1] - data, has list of servers, ig_naming, qdms, quartz_server, AMSS
[2] - some code
[3] - some code?  jumps off to other code segment?
```
...
Memory regions (15/97) (1f0):
  Physical:     0x00a26000 - 0x00a60bff   bootloader  0x0
                0x00b07000 - 0x01e5bbff   bootloader  0x0
                0x16e00000 - 0x17c023ff   bootloader  0x0
